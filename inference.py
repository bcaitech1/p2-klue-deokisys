from transformers import XLMRobertaForSequenceClassification, XLMRobertaTokenizer, AutoTokenizer, BertForSequenceClassification, Trainer, TrainingArguments, BertConfig, BertTokenizer
...
def main(args):
    ...
    output.to_csv(
        './prediction/submission_sep_ent_roberta_e10_b32_lr1e-5_k-fold.csv', index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str,
                        default="./result0/checkpoint-2250")
